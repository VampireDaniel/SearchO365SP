...
function getTokenFromApi(timeSpan, code, callback) {
    var options = {
        host: appConfig.getTokenApiHost,
        port: appConfig.getTokenApiPort,
        path: appConfig.getTokenApiPath + '?timespan=' + timeSpan + '&code=' + code,
        headers: {
            Accept: 'application/json'
        }
    };
